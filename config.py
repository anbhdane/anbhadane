...
## Type: Dict
c.aliases = {'w': 'session-save', 'q': 'close', 'qa': 'quit', 'wq': 'quit --save', 'wqa': 'quit --save','ff':'spawn firefox {url}'}
...
config.bind("\\", 'set-cmd-text -s :open --tab ')
config.bind('B', 'bookmark-add')
## Time interval (in milliseconds) between auto-saves of
## config/cookies/etc.
## Type: Int
## c.auto_save.interval = 1500000000
...
## Type: Dict
## c.url.searchengines = {'DEFAULT': 'https://duckduck.com/?q={}'}
##c.url.searchengines = {'DEFAULT': 'https://duckduckgo.com/?q={}'}
##c.url.searchengines = {'DEFAULT': 'https://google.com/search?source={}'}
